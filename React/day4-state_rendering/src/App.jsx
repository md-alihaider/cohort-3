  ...
  return (
    <div className="min-h-screen bg-gray-500 p-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">
        Hey now data is rendering!
      </h1>

      {/* Added a flex container so cards sit side-by-side on large screens */}
      <div className="flex flex-wrap gap-8 justify-center">
        {productsData.map((product) => {
          return (
            <ProductCard
              key={product.id} /* 2. FIXED: Added the unique key! */
              title={product.title} /* 3. FIXED: Mapped individual props */
              price={product.price}
