...
const ComponentDemo = ({ children, code }: ComponentDemoProps) => {
  ...
  return (
    <div className="border border-(--border-color) rounded-lg overflow-hidden shadow-sm bg-(--muted-bg) ">
      <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-(--subtle-bg) ">
